...
public class BookmarkRestControllerTest {
    ...
    public void createBookmark() throws Exception {
        ...
        this.mockMvc.perform(post("/" + userName + "/bookmarks").contentType(contentType)
    ...
    public void userNotFound() throws Exception {
        mockMvc.perform(post("/george/bookmarks/").content(this.json(new Bookmark(null, null, null)))
