...
public class FileUploadIntegrationTests {
    ...
    public void shouldUploadFile() throws Exception {
        ...
        ResponseEntity<String> response = this.restTemplate.postForEntity(FILES_API, map, String.class);
    ...
    public void shouldDownloadFile() throws Exception {
        Resource resource = new ClassPathResource("testupload.txt", getClass());
        given(this.storageService.loadAsResource("testupload.txt")).willReturn(resource);

        ResponseEntity<String> response = this.restTemplate
                .getForEntity(FILES_API + "/{filename}", String.class, "testupload.txt");
